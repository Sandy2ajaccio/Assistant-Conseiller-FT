        ...
        <Card sx={{ borderRadius: 3, border: '1px solid', borderColor: 'divider' }}>
          <CardContent>
            ...
            <Grid container spacing={1.5}>
              <Grid size={{ xs: 12, sm: 6, md: 2.4 }}><Typography variant="caption" color="text.secondary">Identifiant FT</Typography><Typography variant="body2">{demandeur.identifiantFt || `ANON-${String(demandeur.id || '').padStart(3, '0')}`}</Typography></Grid>
              <Grid size={{ xs: 12, sm: 6, md: 2.4 }}><Typography variant="caption" color="text.secondary">Nom et prénom</Typography><Typography variant="body2">{`${demandeur.prenom || 'Non renseigné'} ${demandeur.nom || ''}`.trim()}</Typography></Grid>
              <Grid size={{ xs: 12, sm: 6, md: 2.4 }}><Typography variant="caption" color="text.secondary">Type d'entretien</Typography><Typography variant="body2">{demandeur.simulateurDecision?.scenarioNom || 'Suivi'}</Typography></Grid>
              <Grid size={{ xs: 12, sm: 6, md: 2.4 }}><Typography variant="caption" color="text.secondary">Durée de l'entretien</Typography><Typography variant="body2">{demandeur.simulateurDecision?.frequenceSuivi || '30 min'}</Typography></Grid>
              <Grid size={{ xs: 12, sm: 6, md: 2.4 }}><Typography variant="caption" color="text.secondary">Statut du dossier</Typography><Chip size="small" label={demandeur.contratEngagement === 'Oui' ? 'Actif' : 'À sécuriser'} /></Grid>
            </Grid>
          </CardContent>
        </Card>
