...
assert.ok(sourcePage.includes('Catégorie du DE'))
assert.ok(sourcePage.includes('Catégorie {categorieActuelle} importée'))
assert.ok(sourcePage.includes('Aucun changement n’est demandé'))
assert.ok(sourcePage.includes('Vérifier ou modifier'))
assert.ok(sourcePage.includes('Cochez rapidement les éléments utiles'))
assert.ok(sourcePage.includes('Projet professionnel'))
assert.ok(sourcePage.includes('Santé / handicap'))
assert.ok(sourcePage.includes('Autre précision (facultatif)'))
assert.ok(sourcePage.includes('Terminer l’exploration'))
assert.ok(!sourcePage.includes('Quel est l’objectif de cet import ?'))
