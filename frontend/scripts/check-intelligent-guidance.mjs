...
assert.ok(sourcePage.includes('Je vous oriente vers le portefeuille GLO de France Travail afin de coordonner les aspects sociaux et professionnels de votre parcours.'))
